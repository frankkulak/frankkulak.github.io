Vue.component('education-content', {
    ...
    template: `
        <div>
            <school-display v-for="school in schools" v-bind:school="school" v-bind:key="school.code"></school-display>
        </div>`
});
...
Vue.component('school-display', {
    ...
    methods: {
        ...
        formatCourses: function (courses) { // fixme replace with css
